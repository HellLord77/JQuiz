 ...
 *
 * Example (5 stars, 3.78 average rating, 3 stars initial selection): StarRater
 * starRater = new StarRater(5, 3.61, 3); starRater.addStarListener(new
 * StarRater.StarListener() { public void handleSelection(int selection) { // a
 * new number of stars has been selected do something... } }); add(starRater);
...
public class StarRater extends JPanel {
     ...
     * the size. Use compressedByteArrayToImage(byte[] data) to retrieve the
     * original image. The image is not recognizable as image from standard
     * tools.
     *
